...
public class Cube {
  ...
  static class GeneratedCube {
    ...
    //Function to scramble the cube (not random)
    ...
    public void move(String movement){
      ...
      //Set the correct row or column values that are being moved by the user
      int rowReference = 0;
      int colReference = 0;
      ...
      //This is for clockwise top or bottom row movement
      if(movement.equals("u") || movement.equals("d\'") || movement.equals("d") || movement.equals("u\'")){
        //Fill the moveHelper with the current values
        ...
        //top and bottom face rotation storage
        int sideCounter = 0;
      ...
      //This is for left and right column movement
      if(movement.equals("l") || movement.equals("r\'") || movement.equals("r") || movement.equals("l\'")){
        ...
        //left and right face rotation storage
        int sideCounter = 0;
        for(int row = 0; row < 3; row++){
          for(int col = 0; col < 3; col++){
      ...
      //This is for front and back side movement
